...
const guideSections: GuideSection[] = [
  ...
  {
    id: 'marketplace',
    title: 'Public Marketplace (Your Game-Changer)',
    icon: Globe,
    description: 'Get discovered by patients searching for medication nearby - the feature that sets you apart',
    steps: [
      'Go to Settings → Marketplace to enable your public listing',
      'Mark products as "Public" in Inventory to list them in the marketplace',
      'Feature products in the Spotlight section (₦1,000-₦2,500 for 7-30 days)',
      'Patients search by drug name, category, or location',
      'Distance filters (1km, 5km, 10km, All) help nearby customers find you',
      'Your pharmacy shows up with address and Google Maps link',
      'Patients order via WhatsApp directly - no commission, 100% your profit',
      'Check Marketplace Insights for views, searches, and engagement data',
    ],
    tips: [
      'This is your #1 differentiator vs generic POS apps - USE IT!',
      'Keep your pharmacy address accurate for distance calculations',
      'Featured products appear in the Spotlight carousel at the top',
      'Products within 5km show a "Fast Pickup" badge to customers',
      'Download the "Find It Near You" flyer to share at hospitals and clinics',
      'The more products you list publicly, the more discoverable you are',
    ],
  },
  {
    id: 'compliance',
