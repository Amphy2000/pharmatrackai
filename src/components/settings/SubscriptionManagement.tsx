...
const plans = [
  {
    id: 'starter',
    name: 'Starter',
    tagline: 'Perfect for single-branch pharmacies',
    setup: '₦150,000',
    setupPrice: 150000,
    monthly: '₦15,000',
    monthlyPrice: 15000,
    ...
    features: ['Up to 500 medications', '1 User Account', 'Basic POS System', 'Expiry Tracking', 'Email Support'],
    popular: false,
  ...
  },
  {
    ...
    features: ['₦0 Setup Fee', 'Unlimited Medications', 'Up to 5 Users', 'Advanced Analytics', 'Multi-Branch Support', 'AI Insights', 'Priority Support'],
    popular: true,
  ...
  },
  {
    ...
    features: ['Everything in Pro', 'Unlimited Users', 'Custom Integrations', 'Dedicated Account Manager', '24/7 Priority Support', 'SLA Guarantee', 'On-site Training'],
    popular: false,
