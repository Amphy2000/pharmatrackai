...
import { AlertTriangle, Package, Calendar, ArrowRight, Bell, TrendingDown, DollarSign, Building2 } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { useBranchAlertEngine } from '@/hooks/useBranchAlertEngine';
...
export const BranchAlertSummaryWidget = () => {
  const { alertCounts, alerts, currentBranchId } = useBranchAlertEngine();
              ...
              <div className="space-y-1">
                ...
                {hasAlerts ? (
                  ...
                  <span className="text-xs text-success flex items-center gap-1">
                    All clear! ✓ No pending alerts for this branch
                  </span>
                )}
              </div>
            </div>
