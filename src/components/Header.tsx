                    ...
                    return (
                      <Tooltip key={link.href}>
                        <TooltipTrigger asChild>
                          <Link
                            to={link.href}
                            className={`flex items-center justify-center 2xl:justify-start gap-1.5 h-9 w-9 2xl:h-auto 2xl:w-auto 2xl:px-3 2xl:py-2 rounded-lg text-sm font-medium transition-all ${isActive
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link
                          ...
                          className={`flex items-center justify-center 2xl:justify-start gap-1.5 h-9 w-9 2xl:h-auto 2xl:w-auto 2xl:px-3 2xl:py-2 rounded-lg text-sm font-medium transition-all ${location.pathname === '/settings'
                              ? 'bg-primary/10 text-primary'
                              : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'
                            }`}
                        >
                  ...
                  {showAdminLink && (
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Link
                          to="/admin"
                          className={`flex items-center justify-center 2xl:justify-start gap-1.5 h-9 w-9 2xl:h-auto 2xl:w-auto 2xl:px-3 2xl:py-2 rounded-lg text-sm font-medium transition-all ${location.pathname === '/admin'
                      ...
                      <Tooltip key={link.href}>
                        <TooltipTrigger asChild>
                          <Link
                            ...
                            className={`flex items-center justify-center h-8 w-8 rounded-lg transition-all flex-shrink-0 ${isActive
                                ? 'bg-primary/10 text-primary'
                                : 'text-muted-foreground hover:text-foreground hover:bg-muted/50'
                              }`}
                          >
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="h-9 w-9 sm:h-11 sm:w-11 rounded-xl hover:bg-muted/50"
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      {notifications.length === 0 ? (
                        ...
                        notifications.map((notification) => (
                          <div
                            key={notification.id}
                            className={`p-4 border-b border-border/30 last:border-0 hover:bg-muted/30 transition-colors cursor-pointer ${!notification.isRead ? 'bg-primary/5' : ''
                              }`}
